...
export function Menu({ onClose }) {
    ...
    return (
        <motion.div
            className="panel-wrapper menu-panel-wrapper"
        ...
        >
            <Paper elevation={4} className="panel-content menu-panel">
                <Box className="panel-header">
                    <Typography variant="h2" className="panel-title">MENU</Typography>
                ...
                <Stack direction="row" spacing={1} justifyContent="center" className="menu-icon-buttons">
                    <IconButton className="menu-icon-btn" aria-label="Settings"><GearIcon /></IconButton>
                    <IconButton className="menu-icon-btn" aria-label="Upload"><UploadIcon /></IconButton>
                    <IconButton className="menu-icon-btn" aria-label="Take screenshot"><CameraIcon /></IconButton>
                </Stack>
