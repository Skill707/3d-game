...
const IconStages = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ transform: 'scale(1.2)'}}>
        <polygon points="12 2 15.5 4 15.5 8 12 10 8.5 8 8.5 4 12 2"></polygon>
        <text x="10.5" y="7.5" fill="currentColor" stroke="none" style={{ fontSize: '5px', fontWeight: 'bold' }}>1</text>
        <polygon points="12 8 15.5 10 15.5 14 12 16 8.5 14 8.5 10 12 8"></polygon>
        <text x="10.5" y="13.5" fill="currentColor" stroke="none" style={{ fontSize: '5px', fontWeight: 'bold' }}>2</text>
        <polygon points="12 14 15.5 16 15.5 20 12 22 8.5 20 8.5 16 12 14"></polygon>
        <text x="10.5" y="19.5" fill="currentColor" stroke="none" style={{ fontSize: '5px', fontWeight: 'bold' }}>3</text>
    </svg>
);
        ...
        <motion.div className="panel-wrapper activation-groups-panel-wrapper" variants={panelVariants} initial="hidden" animate="visible" exit="exit">
            <Paper className="panel-content">
                <Box className="panel-header">
                    <Typography variant="h3" className="panel-title">ACTIVATION GROUPS</Typography>
